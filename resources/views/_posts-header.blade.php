<header class="max-w-xl mx-auto mt-20 text-center">
    <h1 class="text-4xl">
        Latest <span class="text-blue-500">Summer Work 2022</span> News
    </h1>

    <h2 class="inline-flex mt-2">By Lavinia Tinca <img src="/images/lary-head.svg" alt="Head of Lary the mascot"></h2>
